...
export interface InvoiceLinkedDocument {
  id: string;
...
interface InvoiceLinkedDocumentsProps {
  invoiceId: string;
}

const DUMMY_LINKED_DOCUMENTS: InvoiceLinkedDocument[] = [
  {
    id: "doc-001",
    type: "INVOICE",
...
export function InvoiceLinkedDocuments({
  invoiceId: _invoiceId,
}: InvoiceLinkedDocumentsProps) {
