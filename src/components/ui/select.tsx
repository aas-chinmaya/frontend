...
/**
 * Custom props for SelectContent.
 *
 * onViewportScroll is NOT a Radix SelectContent prop.
 * We add it here and forward it to the internal
  ...
  (
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ref={ref}
        className={cn(
          "relative z-[9999] max-h-96 min-w-[8rem] overflow-hidden rounded-md border shadow-md bg-white",
          className
        )}
        position={position}
        {...props}
